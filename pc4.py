...
st.markdown("<h1 style='text-align: center;'>Python y yo 2024-2", unsafe_allow_html=True)
...
col1.image("yo.jpg", caption='Daniela Saavedra, the GOAT', width=300)
...
texto = """
Soy Daniela Saavedra, estudió comunicación audiovisual en la Pontificia Universidad Católica del Perú (PUCP). Me gusta mi carrera porque es muy versátil y amplia y me permite trabajar en muchos sectores del área. Pero, sobre todo, me gusta que es una carrera que me permite desarrollar mi creatividad y mis habilidades artísticas. Por el momento, en el futuro me gustaría trabajar en la dirección de arte o de fotografía de muchas películas. Y lo que más me gusta hacer en mi tiempo libre es leer, ver películas o salir a caminar. 

"""

# Las comillas triples (""") en Python se utilizan para definir cadenas multilínea.
# Mostramos el texto
col2.markdown(f"<div style='text-align: justify; font-size: 19px;'>{texto}</div>", unsafe_allow_html=True)
...
texto_2 = """
 Al principio del curso sentía bastante curiosidad pero también sentí que me iba a costar entender. Lo que me ha enseñado es a respetar los procesos de un sistema y a ser más ordenada. Lo que me gusta de programar es ser capaz de ahora leer códigos y entender cómo se crea todo desde la base, pero a la vez también es algo tedioso. Me gustaría perder crear un código para optimizar algún tipo de trabajo y venderlo 


"""

# Mostramos el texto
st.markdown(f"<div style='text-align: justify; font-size: 19px;'>{texto_2}</div>", unsafe_allow_html=True)
...
graficos = ['Promedio de tarjetas rojas como visitante por equipos de la liga italiana', 'Promedio de goles como visitante', 'Promedio de goles como local']
...
if grafico_seleccionado == 'Promedio de tarjetas rojas como visitante por equipos de la liga italiana':
    ...
    sidebar.image("1.png", caption='Promedio de tarjetas rojas como visitante por equipos de la liga italiana', width=500)
    pass
    ...
    sidebar.image("2.png", caption='Promedio de goles como visitante', width=500)
    pass
elif grafico_seleccionado == 'Promedio de goles como local':
    sidebar.markdown("<div style='text-align: justify'>Texto para la opción 3.</div>", unsafe_allow_html=True)
    sidebar.image("3.png", caption='Promedio de goles como local', width=500)
    pass
